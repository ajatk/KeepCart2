...
public class ApplicationConstants {
    ...
    // http request response code  verify by parminder
    public static final int HTTP_SUCCESS = 200;
    public static final int HTTP_NON_AUTHORATIVE = 203;
    public static final int HTTP_BAD_PARAMS = 400;
    public static final int HTTP_CONFLICT = 409;
    public static final int HTTP_UNPROCESSABLE = 422;
    public static final int HTTP_TOO_MANY_REQUEST = 429;
    public static final int HTTP_NO_CONTENT = 204;
    public static final int CUSTOM_INACTIVE = 910; // custom error for inactive,blocked user or record...
    public static final int BAD_INTERNET_ERROR = -1000;
