...
import com.rs.keepcart.magazines.Collection;

import java.util.List;

public class DatabaseHandlerForModelClass extends SQLiteOpenHelper {
    ...
    public DatabaseHandlerForModelClass(Context context) {
    ...
    public  void addListItems(List<Collection> listItem) {
